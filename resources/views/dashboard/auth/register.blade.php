                        ...
                        <g id="Icon" transform="translate(27.000000, 15.000000)">
                          ...
                          >
                            ...
                            <use fill-opacity="0.2" fill="#FFFFFF" xlink:href="#path-5"></use>
                                ...
                                {{-- <span class="app-brand-text demo text-body fw-bolder">VMS</span> --}}
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">Start Your Journey with VMS 🚀</h4>
                        <p class="mb-4">Register now to manage vaccinations, appointments, and health records
                            effortlessly.</p>
